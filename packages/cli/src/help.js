// 帮助/usage 输出
const USAGE = `Usage: npx xt-sdd-skills <command> [options]

Commands:
  install   First-time installation in current project
  update    Upgrade skills in a project that already has xt-sdd installed
...
Examples:
  ...
  npx xt-sdd-skills update --dry-run
